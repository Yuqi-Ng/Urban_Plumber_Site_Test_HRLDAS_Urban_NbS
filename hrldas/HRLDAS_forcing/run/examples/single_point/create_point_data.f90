...
integer :: var_id_force_temp  , var_id_force_humid , var_id_force_pres   , &
	   ...
	   var_id_force_sw    , var_id_force_lw    , var_id_force_precip, var_id_force_lait, var_id_force_laiv    
...
read(30,*,end=1000) yyyy, mm, dd, hh, nn, uwind_speed, &
	   ...
	   solar_radiation, longwave_radiation, precipitation,lai_tree,lai_veg
...
! Define variables in the file.
  ...
  iret = nf90_def_var(ncid,   "LAI_TREE", NF90_FLOAT, (/dim_id_we,dim_id_sn,dim_id_time/), var_id_force_lait)
    iret = nf90_put_att(ncid, var_id_force_lait, "description", "lai tree")
    iret = nf90_put_att(ncid, var_id_force_lait, "units", "m/m")

  iret = nf90_def_var(ncid,   "LAI_VEG", NF90_FLOAT, (/dim_id_we,dim_id_sn,dim_id_time/), var_id_force_laiv)
    iret = nf90_put_att(ncid, var_id_force_laiv, "description", "lai vegetation")
    iret = nf90_put_att(ncid, var_id_force_laiv, "units", "m/m")
  ...
  iret = nf90_put_var(ncid, var_id_force_lait    , lai_tree           )
  iret = nf90_put_var(ncid, var_id_force_laiv    , lai_veg            )
