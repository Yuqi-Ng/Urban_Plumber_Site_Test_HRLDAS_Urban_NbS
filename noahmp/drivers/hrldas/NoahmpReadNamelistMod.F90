...
!---------------------------------------------------------------------
    ...
    character(len=256)      :: forcing_name_LAIT = "LAI_TREE"         ! added by yuqi
    character(len=256)      :: forcing_name_LAIV = "LAI_VEG"
    ...
    namelist / NOAHLSM_OFFLINE /    &
         ...
         forcing_name_LW,forcing_name_SW,forcing_name_PR,forcing_name_LAIT,               &  ! added by yuqi
         forcing_name_LAIV,  forcing_name_SN,                                             &
   ...
   !
    ...
    NoahmpIO%forcing_name_LAIT                 = forcing_name_LAIT       ! added by yuqi
    NoahmpIO%forcing_name_LAIV                 = forcing_name_LAIV
