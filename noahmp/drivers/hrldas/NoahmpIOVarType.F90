...
!------------------------------------------------------------------------
    ...
    real(kind=kind_noahmp), allocatable, dimension(:,:)    ::  LAI_TREE            ! lai for urban tree [m m-1] ! added by yuqi
    real(kind=kind_noahmp), allocatable, dimension(:,:)    ::  LAI_VEG             ! lai for urban grass[m m-1] ! added by yuqi
...
!------------------------------------------------------------------------
    ...
    ! new urban nbs variables (yuqi)
    real(kind=kind_noahmp), allocatable, dimension(:,:)    ::  cmcg_urb2d
    real(kind=kind_noahmp), allocatable, dimension(:,:)    ::  tvg_urb2d
    real(kind=kind_noahmp), allocatable, dimension(:,:)    ::  tt_urb2d
    real(kind=kind_noahmp), allocatable, dimension(:,:)    ::  xxxvg_urb2d
    real(kind=kind_noahmp), allocatable, dimension(:,:)    ::  flxhumvg_urb2d
    real(kind=kind_noahmp), allocatable, dimension(:,:)    ::  flxhumt_urb2d
    real(kind=kind_noahmp), allocatable, dimension(:,:,:)  ::  tvgl_urb3d
    real(kind=kind_noahmp), allocatable, dimension(:,:,:)  ::  smg_urb3d
...
!---------------------------------------------------------------------
   ...
   ! derived urban dimensions
    ...
    character(len=256)                                     ::  forcing_name_LAIT       ! added by yuqi
    character(len=256)                                     ::  forcing_name_LAIV
